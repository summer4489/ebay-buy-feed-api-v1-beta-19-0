 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ItemSnapshotResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ItemSnapshotResponse';
    ...
    protected static $swaggerTypes = [
        'items' => '\Swagger\Client\Model\ItemSnapshot[]'    ];
     ...
     * Gets items
     *
     * @return \Swagger\Client\Model\ItemSnapshot[]
     */
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\ItemSnapshot[] $items The container for the array of items returned by the getItemSnapshotFeed method. Note: When the value of the availability column is UNAVAILABLE, only the itemId and availability columns are populated.
     *
     * @return $this
     */
