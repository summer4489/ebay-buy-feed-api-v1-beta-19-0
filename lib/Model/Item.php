...
'alerts' => 'getAlerts'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['inferred_gtin'] = isset($data['inferred_gtin']) ? $data['inferred_gtin'] : null;
        $this->container['inferred_brand'] = isset($data['inferred_brand']) ? $data['inferred_brand'] : null;
        $this->container['inferred_mpn'] = isset($data['inferred_mpn']) ? $data['inferred_mpn'] : null;
        $this->container['inferred_localized_aspects'] = isset($data['inferred_localized_aspects']) ? $data['inferred_localized_aspects'] : null;
        ...
        $this->container['length_unit_of_measure'] = isset($data['length_unit_of_measure']) ? $data['length_unit_of_measure'] : null;
     ...
     * Sets category
     *
     * @param string $category The label of the category. For example: Toys &amp; Hobbies|Action Figures|Comic Book Heroes
     *
     * @return $this
     */
     ...
     * Sets condition
     *
     * @param string $condition The text describing the condition of the item. For a list of condition names, see Item Condition IDs and Names. Code so that your app gracefully handles any future changes to this list.
     *
     * @return $this
     */
     ...
     * Sets price_value
     *
     * @param string $price_value The price of the item. This price can be a discounted price. If it is discounted, information about the discount is returned in the originalPriceValue, originalPriceCurrency, discountAmount, and discountPercentage columns.
     *
     * @return $this
     */
     ...
     * Sets item_end_date
     *
     * @param string $item_end_date A timestamp indicating when the item's sale period will end based on its start date and duration. For Good 'Til Cancelled items, no value is returned in this column. Format: UTC (yyyy-MM-ddThh:mm:ss.sssZ).
     *
     * @return $this
     */
     ...
     * Sets refund_method
     *
     * @param string $refund_method An enumeration value that indicates how a buyer is refunded when an item is returned. Code so that your app gracefully handles any future changes to this list. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/feed/types/RefundMethodEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets inferred_brand
     *
     * @param string $inferred_brand The name brand for the item, such as Nike or Apple, which has been programmatically determined by eBay. To identify the product, this is always used along with MPN. If the seller provided a brand for the item, the seller's value is returned in the brand column.
     *
     * @return $this
     */
     ...
     * Sets inferred_mpn
     *
     * @param string $inferred_mpn The MPN (Manufacturer's Part Number) for the item, which has been programmatically determined by eBay. To identify the product, this is always used along with brand. If the seller provided a MPN for the item, the seller's value is returned in the mpn column.
     *
     * @return $this
     */
     ...
     *
     * @param string $length_unit_of_measure The unit of measurement used for the package dimensions, such as INCH, FEET, CENTIMETER, or METER. Code so that your app gracefully handles any future changes to this list. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/feed/types/LengthUnitOfMeasureEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets package_width
     *
     * @param string $package_width The width of the shipping package that contains the item.
     *
     * @return $this
     */
     ...
     * Sets package_height
     *
     * @param string $package_height The height of the shipping package that contains the item.
     *
     * @return $this
     */
     ...
     * Sets package_length
     *
     * @param string $package_length The length of the shipping package that contains the item.
     *
     * @return $this
     */
     ...
     *
     * @param string $weight_unit_of_measure The unit of measurement used for the package weight, such as POUND, KILOGRAM, OUNCE, or GRAM. Code so that your app gracefully handles any future changes to this list. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/feed/types/WeightUnitOfMeasureEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets package_weight
     *
     * @param string $package_weight The weight of the package that contains the item.
     *
     * @return $this
     */
     ...
     *
     * @param string $shipping_cost_type Indicates the class of the shipping cost. Valid Values: FIXED or CALCULATED.
     *
     * @return $this
     */
